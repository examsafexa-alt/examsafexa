...
const TEAM = [
  {
    ...
    copy: "Driving the vision for Exam Safexa and Safexa Technologies : building a safer exam journey for students and the families who worry about them. Started this because every year, millions of Indian students travel alone to life-changing exams with no trusted way to find someone to make that journey with.",
  ...
  },
  {
    ...
    copy: "Spearheading R&D at Exam Safexa : researching government exams, universities, scholarships, and student needs to shape what we build next. Works on product planning, exam database design, and market validation.",
